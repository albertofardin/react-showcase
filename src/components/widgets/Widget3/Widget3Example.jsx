...
import "./Widget3Example.css";

const faqs = [
  {
    header: (
      <div className="accordion-2-header">
        <span className="material-symbols-outlined">mail</span> Delivery
      </div>
    ),
  ...
  },
  {
    header: (
      <div className="accordion-2-header">
        <span className="material-symbols-outlined">credit_card</span> Returns &
        Refunds
      </div>
    ),
  ...
  },
  {
    header: (
      <div className="accordion-2-header">
        <span className="material-symbols-outlined">warning</span> Order Issues
      </div>
    ),
  ...
  },
  {
    header: (
      <div className="accordion-2-header">
        <span className="material-symbols-outlined">package_2</span> Products &
        Stock
      </div>
    ),
